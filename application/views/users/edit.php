...
$level=array(1=>'Admin',2=>'Operator');
...
<table class="table table-bordered">
    ...
    <td width="150">Password</td><td>
     ...
     <tr>
    <td width="150">Real Name</td><td>
        <div class="col-sm-3"><?php echo form_input('real_name',$r['nama'],'width="100px" placeholder=\'real name ..\' class=\'form-control\'');?></div>
    ...
    <td>
        <div class="col-sm-3">
        <?php echo form_dropdown('instansi',$dd_instansi,'',$class);?>
        </div>
