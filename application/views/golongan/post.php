  ...
  <div class="col-md-12 clearfix">
     ...
     <tr class="success">
      ...
      <tr>
        ...
        <td><?php echo inputan('text', 'kode_gol','col-sm-2','Kode Golongan ..', 1, '','');?></td>
	   </tr>
		<tr>
		  <td width="150">Golongan</td>
		  <td>
		<?php  echo inputan('text', 'gol','col-sm-6','Nama Golongan ..', 0, '','');?>		</td></tr>
        
        <tr>
        <td>Keterangan</td>
        <td>
        <?php echo inputan('text', 'keterangan','col-sm-6','Keterangan ..', 0, '','');?>        </td>
       </tr>
      </table>
